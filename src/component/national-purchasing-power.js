...
export default function NationalPurchasingPower() {
    ...
    return (
        <>
            ...
            <p> Uma forma de determinar o poder de compra de uma moeda, é comparar a quantidade comprada de um determinado produto há alguns anos com a quantidade comprada nos dias de hoje, levando em consideração que foi usado a mesma quantia para a compra. </p>
            ...
            <h4>Comparação entre países <small>(neste site)</small></h4>
            <p>
                A comparação realizada neste site, utiliza os dados buscados em <a href="https://www.quandl.com/data/ECONOMIST-The-Economist-Big-Mac-Index"> Quandl </a> como o valor do <em>Big Mac</em>
                e o dados buscados em <a href="https://pt.countryeconomy.com/mercado-laboral/salario-minimo-nacional"> Country Economy</a> como o salário mínimo do país.
            </p>
